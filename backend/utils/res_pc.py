...
from backend.embeddings import resume_embeddings
from backend.embeddings import jd_embeddings
...
def query_resume_chunks_for_jd(index: Index, resume_id: int, jd_text: str, top_k : int = 5) -> list[dict]:
